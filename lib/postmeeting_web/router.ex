defmodule PostmeetingWeb.Router do
  ...
  scope "/", PostmeetingWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{PostmeetingWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", PostmeetingWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{PostmeetingWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", PostmeetingWeb do
    ...
    live_session :current_user,
      on_mount: [{PostmeetingWeb.UserAuth, :mount_current_user}] do
